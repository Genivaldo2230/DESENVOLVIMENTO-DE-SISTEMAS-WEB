...
function carregarDados() {
  ...
  promise.then(function (dados) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const idiomasHeader = idiomasContainer.querySelector('h3');
      const idiomasTable = idiomasContainer.querySelector('table tbody');

      idiomasHeader.textContent = 'Idiomas';
  ...
  // Your implementation for carregarSeguidores goes here
  console.log('carregarSeguidores function called');
}
